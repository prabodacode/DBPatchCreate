...
INSERT INTO dfn_ntp.z02_forms_cols (1_sql,Z02_MAPPING_NAME,Z02_COLUMN_NAME,Z02_WIDTH,Z02_ALIGNMENT,Z02_FORMAT,Z02_SEQ_NO,Z02_VISIBLE,Z02_TRANSLATABLE,Z02_SHOW_BY_DEFAULT,Z02_FORCE_DEFAULT_FORMATTING,Z02_ADJUST_GMT,Z02_FORMAT_BASED_ON_CURRENCY,Z02_CURRENCY_FIELD_NAME,Z02_SHOW_TOTAL,Z02_FIXED_FILTER_VALUE,Z02_MIN_FILTER_LENGTH,Z02_SHOW_IN_FILTER,Z02_COLUMN_TYPE,Z02_FEATURE_ID_V14,Z02_CASE_SENSITIVE,Z02_OPERATOR)
...
MERGE INTO dfn_ntp.v00_sys_config
 USING DUAL
    ON (1_sql = 'OTP_RESEND_DELAY_PERIOD')
WHEN NOT MATCHED
THEN
    INSERT (v00_id,
            v00_value,
